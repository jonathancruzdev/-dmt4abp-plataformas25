...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-11-2025 a las 21:26:05
...
INSERT INTO `inscripciones` (`id_inscripcion`, `id_usuario`, `fecha`, `id_carrera`, `detalle`) VALUES
(1, 1, '2025-09-08', 4, ''),
(2, 1, '2025-11-13', 5, 'Un detalle'),
(3, 4, '2025-11-13', 2, 'Me quiero inscribir en la carrera!'),
(4, 4, '2025-11-13', 3, 'asa');
...
(4, 'Diseño Web', 'HTML, CSS y Bootstrap', 2);
...
(4, 'Julieta', '81dc9bdb52d04dc20036dbd8313ed055', 'julieta@dv.edu.ar', 1),
(6, 'Juan', '81dc9bdb52d04dc20036dbd8313ed055', 'juan@dv.edu.ar', 1);
